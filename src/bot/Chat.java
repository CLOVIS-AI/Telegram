...
public class Chat {
    ...
    /**
     * This method might not work if the two Chats were not generated by the same bot ! 
     * @param obj the other chat
     * @return <code>true</code> if they are the same Chat (calculated with ID).
     */
    @Override
